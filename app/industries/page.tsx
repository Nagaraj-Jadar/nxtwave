...
export const metadata: Metadata = { title: 'Industries', description: 'NXTwave supports semiconductor programs across automotive, AI, connectivity, IoT, industrial, and medical markets.' }
